 ...
 */
final class Version20190605220311 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog DROP sort');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog ADD sort INT UNSIGNED DEFAULT 1 NOT NULL');
    }
}
